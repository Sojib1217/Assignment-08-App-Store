...
const Banner = () => {
    return (
        <div className='text-center pt-20'>
            ...
            <p className='text-lg p-4 w-full md:w-2/3 mx-auto mt-4 opacity-60'>At APP-ZONE, we craft innovative apps designed to make everyday life simpler, smarter, and more exciting. Our goal is to turn your ideas into digital experiences that truly make an impact.</p>
